...
{
    public class QuanTri_63135741Controller : Controller
    {
        ...
        public ActionResult DangNhap_63135741()
        {
            return View();
        }
        [HttpPost]
        ...
        public ActionResult DangNhap_63135741(QuanTri qt)
        {
            if (ModelState.IsValid)
            {
                if (CheckUser(qt.Email, qt.Password))
                {
                    ...
                    return RedirectToAction("Index", "NhanVien_63135741/Index");
                }
                else
